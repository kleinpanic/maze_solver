...
class MazeSolverApp:
    ...
    def solve_maze(self, show_dialog=True):
        ...
        self.solver_step_id = self.root.after(0, self._process_solver_step)
    ...
    def _process_solver_step(self):
        ...
        try:
            ...
            self.solver_step_id = self.root.after(self.render.solve_delay_ms(), self._process_solver_step)
    ...
    def request_stop_solver(self, show_message=True):
        ...
        self.solving = False
        self.stop_timer()
        if self.solver_step_id:
            try:
                self.root.after_cancel(self.solver_step_id)
            except tk.TclError:
                pass
            self.solver_step_id = None
